    ...
    <section id="about">
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-10 left-10 w-2 h-2 bg-blue-300 rounded-full animate-pulse opacity-40"></div>
          <div className="absolute top-32 right-20 w-1 h-1 bg-blue-400 rounded-full animate-bounce delay-1000 opacity-30"></div>
          <div className="absolute bottom-20 left-1/4 w-1.5 h-1.5 bg-blue-200 rounded-full animate-ping delay-500 opacity-50"></div>
        </div>

        <div className="flex flex-col lg:flex-row items-start justify-between gap-16 max-w-6xl mx-auto relative z-10">
          ...
          <div className={`w-full lg:w-1/2 transition-all duration-1000 ${
            ...
            <div className="w-full aspect-[4/3] bg-gradient-to-br from-blue-50 to-gray-100 rounded-xl overflow-hidden shadow-lg border border-gray-200 group relative">
              ...
              <img
                ...
                className="w-full h-full object-cover opacity-90 hover:opacity-100 transition-all duration-500 group-hover:scale-105 relative z-20"
              />
              
             
              <div className="absolute top-4 right-4 w-3 h-3 bg-blue-400 rounded-full opacity-0 group-hover:opacity-60 transition-all duration-500 group-hover:animate-ping"></div>
              <div className="absolute bottom-4 left-4 w-2 h-2 bg-blue-300 rounded-full opacity-0 group-hover:opacity-40 transition-all duration-700 group-hover:animate-bounce"></div>
            </div>
          </div>

         
          <div className="w-full lg:w-1/2 lg:pl-8">
            <h2 className={`text-4xl sm:text-5xl font-bold text-gray-800 mb-8 leading-tight transition-all duration-1000 delay-200 ${
              visibleSections.about 
              ...
              <span className="relative">
                ...
                <div className={`absolute bottom-0 left-0 h-1 bg-gradient-to-r from-blue-500 to-blue-300 transition-all duration-1000 delay-800 ${
            ...
            <div className="space-y-6">
              <p className={`text-gray-600 text-base leading-relaxed transition-all duration-1000 delay-400 ${
                visibleSections.about 
                  ? 'opacity-100 translate-y-0' 
                  : 'opacity-0 translate-y-6'
              }`}>
                IEEEXtreme is a premier global programming competition where
                teams of IEEE Student Members – guided by an IEEE member and
                often supported by their local IEEE Student Branch – take on a
                <span className="text-blue-600 font-medium"> thrilling 24-hour challenge</span> to solve a series of complex
                algorithmic problems.
              </p>
              <p className={`text-gray-600 text-base leading-relaxed transition-all duration-1000 delay-600 ${
                visibleSections.about 
                  ? 'opacity-100 translate-y-0' 
                  : 'opacity-0 translate-y-6'
              }`}>
                Held simultaneously across the world, IEEEXtreme pushes
                participants to the limits of their coding skills,
                problem-solving abilities, and teamwork under 
                <span className="text-blue-600 font-medium"> intense time pressure</span>. It's not just about competing—it's about 
                <span className="text-blue-600 font-medium"> learning, networking, and showcasing talent</span> on an international stage.
              </p>
            </div>
          </div>
        </div>
